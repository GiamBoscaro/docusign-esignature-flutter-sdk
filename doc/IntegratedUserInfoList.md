# docusign_esignature_flutter_sdk.model.IntegratedUserInfoList
...
------------ | ------------- | ------------- | -------------
**allUsersSelected** | **String** |  | [optional] 
...
**users** | [**List<UserInfo>**](UserInfo.md) | User management information. | [optional] [default to const []]
