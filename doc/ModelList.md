# docusign_esignature_flutter_sdk.model.ModelList
...
**listItems** | [**List<ListItem>**](ListItem.md) | The list of values that can be selected by senders. The list values are separated by semi-colons. Example: [one;two;three;four]  Maximum Length of listItems:  2048 characters. Maximum Length of items in the list: 100 characters.   | [optional] [default to const []]
**listSelectedValue** | **String** | The value in the list that is selected by default. | [optional] 
**listSelectedValueMetadata** | [**PropertyMetadata**](PropertyMetadata.md) |  | [optional] 
