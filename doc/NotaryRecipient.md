# docusign_esignature_flutter_sdk.model.NotaryRecipient
...
**email** | **String** | The recipient's email address. Notification of the document to sign is sent to this email address.  Maximum length: 100 characters. | [optional] 
...
**liveOakStartURL** | **String** | URL that directs the recipient to LiveOak to complete the remote online notarization process. This property is read-only. | [optional] 
...
**notaryId** | **String** | Not applicable to Notary tab. | [optional] 
**notarySignerEmailSent** | **String** |  | [optional] 
**notarySigners** | **List<String>** | An array of strings that correspond to the `recipientId` of each signer in the notary group. This property is read-only. | [optional] [default to const []]
**notarySourceType** | **String** |  | [optional] 
**notaryType** | **String** | The notary type. This property is read-only. Valid values:  - `inperson` - `remote` | [optional] 
