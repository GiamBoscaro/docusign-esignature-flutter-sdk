# docusign_esignature_flutter_sdk.model.GroupUsers
...
**users** | [**List<UserInfo>**](UserInfo.md) | An array of `userInfo` objects containing information about the users in the group. | [optional] [default to const []]
