# docusign_esignature_flutter_sdk.model.Witness
...
**creationReason** | **String** | The reason why the recipient was created (for example, `sender`). This property is read-only. | [optional] 
...
**witnessFor** | **String** | The `recipientId` of the person or party for whom the recipient is a witness. | [optional] 
**witnessForGuid** | **String** | Not used. Use the `witnessFor` property instead. | [optional] 
