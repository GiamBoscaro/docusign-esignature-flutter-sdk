# docusign_esignature_flutter_sdk.model.SmartSection
...
**caseSensitive** | **bool** | When **true,** the `startAnchor` and `endAnchor` for the Smart Section must match both the case and the content of the strings in the HTML. | [optional] 
...
**displaySettings** | [**SmartSectionDisplaySettings**](SmartSectionDisplaySettings.md) |  | [optional] 
...
**endPosition** | [**SmartSectionAnchorPosition**](SmartSectionAnchorPosition.md) |  | [optional] 
...
**overlayType** | **String** | The type of overlay to draw on the document. The following overlay types are supported:  - `line` - `outline`  | [optional] 
...
**startPosition** | [**SmartSectionAnchorPosition**](SmartSectionAnchorPosition.md) |  | [optional] 
