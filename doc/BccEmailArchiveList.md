# docusign_esignature_flutter_sdk.model.BccEmailArchiveList
...
------------ | ------------- | ------------- | -------------
**bccEmailArchives** | [**List<BccEmailArchive>**](BccEmailArchive.md) | A list of  BCC email archive configurations. | [optional] [default to const []]
