# docusign_esignature_flutter_sdk.model.PolyLineOverlay
...
**graphicsContext** | [**GraphicsContext**](GraphicsContext.md) |  | [optional] 
...
**overlayType** | **String** | The type of overlay to use. The API currently supports only the `outline` overlay type. | [optional] 
...
**polyLines** | [**List<PolyLine>**](PolyLine.md) | An array of `polyLine` objects that contain x- and y-coordinates representing the locations of the lines. | [optional] [default to const []]
...
**shared** | **String** | When **true,** indicates that the tab is shared. | [optional] 
