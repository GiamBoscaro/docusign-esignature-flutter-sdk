# docusign_esignature_flutter_sdk.model.ExternalFolder
...
**items** | [**List<ExternalFile>**](ExternalFile.md) | If the tab is a list, this represents the values that are possible for the tab. | [optional] [default to const []]
