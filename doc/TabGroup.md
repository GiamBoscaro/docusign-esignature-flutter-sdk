# docusign_esignature_flutter_sdk.model.TabGroup
...
**groupLabel** | **String** | A unique identifier for a tab group. To assign a tab to the `tabGroup`, you assign the `TabGroupLabel` to the `tab.TabGroupLabels` array. | [optional] 
**groupLabelMetadata** | [**PropertyMetadata**](PropertyMetadata.md) |  | [optional] 
**groupRule** | **String** | Specifies how `maximumAllowed` and `minimumRequired` are interpreted when selecting tabs in a `tabGroup`.  Possible values are:  - `SelectAtLeast` - `SelectAtMost` - `SelectExactly` - `SelectARange`   | [optional] 
**groupRuleMetadata** | [**PropertyMetadata**](PropertyMetadata.md) |  | [optional] 
**height** | **String** | The height of the tab in pixels. | [optional] 
**heightMetadata** | [**PropertyMetadata**](PropertyMetadata.md) |  | [optional] 
**maximumAllowed** | **String** | The maximum number of tabs within the `tabGroup` that should be checked, populated, or signed. This property is used for validation. | [optional] 
**maximumAllowedMetadata** | [**PropertyMetadata**](PropertyMetadata.md) |  | [optional] 
**mergeField** | [**MergeField**](MergeField.md) |  | [optional] 
**mergeFieldXml** | **String** | Reserved for DocuSign. | [optional] 
**minimumRequired** | **String** | The minimum number of of tabs within the `tabGroup` that should be checked, populated, or signed. This property is used for validation. | [optional] 
**minimumRequiredMetadata** | [**PropertyMetadata**](PropertyMetadata.md) |  | [optional] 
...
**tabScope** | **String** | The scope of the tab group. Possible values are:  - `document` - `envelope` (default) | [optional] 
**tabScopeMetadata** | [**PropertyMetadata**](PropertyMetadata.md) |  | [optional] 
