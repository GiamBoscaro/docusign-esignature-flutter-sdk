# docusign_esignature_flutter_sdk.model.Draw
...
------------ | ------------- | ------------- | -------------
**allowSignerUpload** | **String** | When **true,** the recipient can upload an image to use as the background of the drawing field. The default value is **false.** | [optional] 
...
**useBackgroundAsCanvas** | **String** |  | [optional] 
