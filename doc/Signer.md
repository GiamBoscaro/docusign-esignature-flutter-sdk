# docusign_esignature_flutter_sdk.model.Signer
...
**agentCanEditEmail** | **String** | Optional element. When **true,** the agent recipient associated with this recipient can change the recipient's pre-populated email address. This element is only active if enabled for the account. | [optional] 
**agentCanEditName** | **String** | Optional. When **true,** the agent recipient associated with this recipient can change the recipient's pre-populated name. This element is only active if enabled for the account. | [optional] 
...
**canSignOffline** | **String** | When **true,** specifies that the signer can perform the signing ceremony offline. | [optional] 
...
**delegatedBy** | [**DelegationInfo**](DelegationInfo.md) |  | [optional] 
**delegatedTo** | [**List<DelegationInfo>**](DelegationInfo.md) |  | [optional] [default to const []]
...
**email** | **String** | The recipient's email address. The system sends notifications about the documents to sign to this address. Maximum length: 100 characters.  | [optional] 
...
**notaryId** | **String** | The `recipientId` of the notary for this signer. | [optional] 
**notarySignerEmailSent** | **String** |  | [optional] 
