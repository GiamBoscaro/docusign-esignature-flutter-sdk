...
// tests for BccEmailArchiveHistoryList
void main() {
  // final instance = BccEmailArchiveHistoryList();

  group('test BccEmailArchiveHistoryList', () {
    // A list of changes to the BCC email archive configuration.
    // List<BccEmailArchiveHistory> bccEmailArchiveHistory (default value: const [])
    test('to test the property `bccEmailArchiveHistory`', () async {
      // TODO
    });
