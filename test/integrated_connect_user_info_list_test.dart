...
// tests for IntegratedConnectUserInfoList
void main() {
  // final instance = IntegratedConnectUserInfoList();

  group('test IntegratedConnectUserInfoList', () {
    ...
    // List<ConnectUserInfo> users (default value: const [])
