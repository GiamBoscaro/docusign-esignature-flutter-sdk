...
/// tests for TemplateDocumentHtmlDefinitionsApi
void main() {
  // final instance = TemplateDocumentHtmlDefinitionsApi();

  group('tests for TemplateDocumentHtmlDefinitionsApi', () {
    ...
    test('test responsiveHtmlGetTemplateDocumentHtmlDefinitions', () async {
      // TODO
    });
