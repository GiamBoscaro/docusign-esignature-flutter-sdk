...
// tests for NotaryJurisdictionList
void main() {
  // final instance = NotaryJurisdictionList();

  group('test NotaryJurisdictionList', () {
    ...
    // List<NotaryJurisdiction> notaryJurisdictions (default value: const [])
    test('to test the property `notaryJurisdictions`', () async {
      // TODO
    });
