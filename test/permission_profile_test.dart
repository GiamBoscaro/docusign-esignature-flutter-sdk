...
// tests for PermissionProfile
void main() {
  // final instance = PermissionProfile();

  group('test PermissionProfile', () {
    // The username of the user who last modified the permission profile.
    // String modifiedByUsername
    test('to test the property `modifiedByUsername`', () async {
      // TODO
    });

    // The date and time when the permission profile was last modified.
    // String modifiedDateTime
    test('to test the property `modifiedDateTime`', () async {
      // TODO
    });
    ...
    // List<UserInformation> users (default value: const [])
