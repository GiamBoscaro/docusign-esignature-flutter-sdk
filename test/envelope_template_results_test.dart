...
// tests for EnvelopeTemplateResults
void main() {
  // final instance = EnvelopeTemplateResults();

  group('test EnvelopeTemplateResults', () {
    ...
    // List<EnvelopeTemplate> envelopeTemplates (default value: const [])
    test('to test the property `envelopeTemplates`', () async {
      // TODO
    });
