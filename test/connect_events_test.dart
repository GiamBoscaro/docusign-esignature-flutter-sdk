...
// tests for ConnectEvents
void main() {
  // final instance = ConnectEvents();

  group('test ConnectEvents', () {
    // A list of Connect failure logs.
    // List<ConnectLog> failures (default value: const [])
    test('to test the property `failures`', () async {
      // TODO
    });

    // A list of Connect general logs.
    // List<ConnectLog> logs (default value: const [])
