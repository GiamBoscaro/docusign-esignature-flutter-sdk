...
// tests for EnvelopeTransferRuleInformation
void main() {
  // final instance = EnvelopeTransferRuleInformation();

  group('test EnvelopeTransferRuleInformation', () {
    ...
    // List<EnvelopeTransferRule> envelopeTransferRules (default value: const [])
    test('to test the property `envelopeTransferRules`', () async {
      // TODO
    });
