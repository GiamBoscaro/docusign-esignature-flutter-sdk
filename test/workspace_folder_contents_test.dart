...
// tests for WorkspaceFolderContents
void main() {
  // final instance = WorkspaceFolderContents();

  group('test WorkspaceFolderContents', () {
    ...
    // List<WorkspaceItem> items (default value: const [])
    test('to test the property `items`', () async {
      // TODO
    });

    // 
    // List<WorkspaceItem> parentFolders (default value: const [])
    test('to test the property `parentFolders`', () async {
      // TODO
    });
