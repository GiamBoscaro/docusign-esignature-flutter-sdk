...
// tests for EnvelopeNotificationRequest
void main() {
  // final instance = EnvelopeNotificationRequest();

  group('test EnvelopeNotificationRequest', () {
    // Expirations expirations
    test('to test the property `expirations`', () async {
      // TODO
    });
    ...
    test('to test the property `useAccountDefaults`', () async {
      // TODO
    });
