...
// tests for WorkspaceItems
void main() {
  // final instance = WorkspaceItems();

  group('test WorkspaceItems', () {
    // WorkspaceUserAuthorization callerAuthorization
    test('to test the property `callerAuthorization`', () async {
      // TODO
    });
    ...
    test('to test the property `createdByInformation`', () async {
      // TODO
    });
    ...
    test('to test the property `lastModifiedById`', () async {
      // TODO
    });

    // WorkspaceUser lastModifiedByInformation
    test('to test the property `lastModifiedByInformation`', () async {
      // TODO
    });
    ...
    test('to test the property `parentFolderId`', () async {
      // TODO
    });

    // The URI of the parent folder.
    // String parentFolderUri
    test('to test the property `parentFolderUri`', () async {
      // TODO
    });
    ...
    test('to test the property `userAuthorization`', () async {
      // TODO
    });
