...
// tests for BulkRecipientsResponse
void main() {
  // final instance = BulkRecipientsResponse();

  group('test BulkRecipientsResponse', () {
    // A complex type containing information about the bulk recipients in the response.
    // List<BulkRecipient> bulkRecipients (default value: const [])
    test('to test the property `bulkRecipients`', () async {
      // TODO
    });
