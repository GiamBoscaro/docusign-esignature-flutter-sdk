...
// tests for NotaryJournalList
void main() {
  // final instance = NotaryJournalList();

  group('test NotaryJournalList', () {
    ...
    // 
    // List<NotaryJournal> notaryJournals (default value: const [])
    test('to test the property `notaryJournals`', () async {
      // TODO
    });
