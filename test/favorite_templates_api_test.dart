...
/// tests for FavoriteTemplatesApi
void main() {
  // final instance = FavoriteTemplatesApi();

  group('tests for FavoriteTemplatesApi', () {
    ...
    test('test favoriteTemplatesGetFavoriteTemplates', () async {
      // TODO
    });
    ...
    test('test favoriteTemplatesPutFavoriteTemplate', () async {
      // TODO
    });
    ...
    test('test favoriteTemplatesUnFavoriteTemplate', () async {
      // TODO
    });
