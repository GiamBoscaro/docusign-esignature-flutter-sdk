...
// tests for UserSocialIdResult
void main() {
  // final instance = UserSocialIdResult();

  group('test UserSocialIdResult', () {
    // Contains properties that map a DocuSign user to a social account such as Facebook or Yahoo.
    // List<SocialAccountInformation> socialAccountInformation (default value: const [])
    test('to test the property `socialAccountInformation`', () async {
      // TODO
    });
