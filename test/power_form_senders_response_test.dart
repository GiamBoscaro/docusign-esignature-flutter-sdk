...
// tests for PowerFormSendersResponse
void main() {
  // final instance = PowerFormSendersResponse();

  group('test PowerFormSendersResponse', () {
    ...
    // List<UserInfo> powerFormSenders (default value: const [])
    test('to test the property `powerFormSenders`', () async {
      // TODO
    });
