...
// tests for PowerFormFormDataRecipient
void main() {
  // final instance = PowerFormFormDataRecipient();

  group('test PowerFormFormDataRecipient', () {
    // 
    // String email
    ...
    // 
    // List<NameValue> formData (default value: const [])
