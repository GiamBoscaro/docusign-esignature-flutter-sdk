...
// tests for Watermark
void main() {
  // final instance = Watermark();

  group('test Watermark', () {
    // 
    // String displayAngle
    test('to test the property `displayAngle`', () async {
      // TODO
    });
    ...
    // 
    // String transparency
    test('to test the property `transparency`', () async {
      // TODO
    });

    // 
    // String watermarkText
    test('to test the property `watermarkText`', () async {
      // TODO
    });
