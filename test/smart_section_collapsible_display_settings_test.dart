...
// tests for SmartSectionCollapsibleDisplaySettings
void main() {
  // final instance = SmartSectionCollapsibleDisplaySettings();

  group('test SmartSectionCollapsibleDisplaySettings', () {
    ...
    // String arrowClosed
    test('to test the property `arrowClosed`', () async {
      // TODO
    });

    // A CSS color value (such as `#DCF851`) that indicates the color of the arrow. 
    // String arrowColor
    test('to test the property `arrowColor`', () async {
      // TODO
    });
    ...
    test('to test the property `arrowLocation`', () async {
      // TODO
    });
    ...
    test('to test the property `onlyArrowIsClickable`', () async {
      // TODO
    });
    ...
    test('to test the property `outerLabelAndArrowStyle`', () async {
      // TODO
    });
