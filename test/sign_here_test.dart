...
void main() {
  ...
  group('test SignHere', () {
    ...
    test('to test the property `handDrawRequired`', () async {
      // TODO
    });
    ...
    test('to test the property `isSealSignTab`', () async {
      // TODO
    });
    ...
    test('to test the property `optionalMetadata`', () async {
      // TODO
    });
    ...
    test('to test the property `scaleValueMetadata`', () async {
      // TODO
    });
    ...
    // Stamp stamp
    test('to test the property `stamp`', () async {
      // TODO
    });
