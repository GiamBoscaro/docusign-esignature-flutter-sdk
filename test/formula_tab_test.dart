...
// tests for FormulaTab
void main() {
  // final instance = FormulaTab();

  group('test FormulaTab', () {
    ...
    test('to test the property `formulaMetadata`', () async {
      // TODO
    });
    ...
    test('to test the property `hiddenMetadata`', () async {
      // TODO
    });

    // PropertyMetadata isPaymentAmountMetadata
    test('to test the property `isPaymentAmountMetadata`', () async {
      // TODO
    });
    ...
    test('to test the property `roundDecimalPlaces`', () async {
      // TODO
    });

    // PropertyMetadata roundDecimalPlacesMetadata
    test('to test the property `roundDecimalPlacesMetadata`', () async {
      // TODO
    });
    ...
    test('to test the property `shareToRecipients`', () async {
      // TODO
    });

    // PropertyMetadata shareToRecipientsMetadata
    test('to test the property `shareToRecipientsMetadata`', () async {
      // TODO
    });
    ...
    test('to test the property `validationPatternMetadata`', () async {
      // TODO
    });
