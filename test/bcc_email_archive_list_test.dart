...
// tests for BccEmailArchiveList
void main() {
  // final instance = BccEmailArchiveList();

  group('test BccEmailArchiveList', () {
    // A list of  BCC email archive configurations.
    // List<BccEmailArchive> bccEmailArchives (default value: const [])
    test('to test the property `bccEmailArchives`', () async {
      // TODO
    });
