...
// tests for IntegratedUserInfoList
void main() {
  // final instance = IntegratedUserInfoList();

  group('test IntegratedUserInfoList', () {
    // 
    // String allUsersSelected
    test('to test the property `allUsersSelected`', () async {
      // TODO
    });
    ...
    // List<UserInfo> users (default value: const [])
