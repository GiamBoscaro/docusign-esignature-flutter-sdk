...
/// tests for AccountSignatureProvidersApi
void main() {
  // final instance = AccountSignatureProvidersApi();

  group('tests for AccountSignatureProvidersApi', () {
    ...
    test('test accountSignatureProvidersGetSignatureProviders', () async {
      // TODO
    });
