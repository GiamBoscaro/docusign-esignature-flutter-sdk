...
// tests for SmartSection
void main() {
  // final instance = SmartSection();

  group('test SmartSection', () {
    ...
    // bool caseSensitive
    test('to test the property `caseSensitive`', () async {
      // TODO
    });
    ...
    test('to test the property `displaySettings`', () async {
      // TODO
    });
    ...
    // String endAnchor
    test('to test the property `endAnchor`', () async {
      // TODO
    });
    ...
    test('to test the property `removeEndAnchor`', () async {
      // TODO
    });
    ...
    test('to test the property `removeStartAnchor`', () async {
      // TODO
    });
    ...
    // String startAnchor
    test('to test the property `startAnchor`', () async {
      // TODO
    });
