...
// tests for NotaryRecipient
void main() {
  // final instance = NotaryRecipient();

  group('test NotaryRecipient', () {
    ...
    test('to test the property `agentCanEditEmail`', () async {
      // TODO
    });
    ...
    test('to test the property `agentCanEditName`', () async {
      // TODO
    });
    ...
    test('to test the property `bulkRecipientsUri`', () async {
      // TODO
    });
    ...
    test('to test the property `delegatedBy`', () async {
      // TODO
    });

    // 
    // List<DelegationInfo> delegatedTo (default value: const [])
    test('to test the property `delegatedTo`', () async {
      // TODO
    });
    ...
    test('to test the property `isBulkRecipient`', () async {
      // TODO
    });

    // PropertyMetadata isBulkRecipientMetadata
    test('to test the property `isBulkRecipientMetadata`', () async {
      // TODO
    });
    ...
    test('to test the property `liveOakStartURL`', () async {
      // TODO
    });
    ...
    test('to test the property `notarySignerEmailSent`', () async {
      // TODO
    });

    // An array of strings that correspond to the `recipientId` of each signer in the notary group. This property is read-only.
    // List<String> notarySigners (default value: const [])
    test('to test the property `notarySigners`', () async {
      // TODO
    });

    // 
    // String notarySourceType
    test('to test the property `notarySourceType`', () async {
      // TODO
    });

    // The notary type. This property is read-only. Valid values:  - `inperson` - `remote`
    // String notaryType
    test('to test the property `notaryType`', () async {
      // TODO
    });
    ...
    test('to test the property `offlineAttributes`', () async {
      // TODO
    });
    ...
    test('to test the property `proofFile`', () async {
      // TODO
    });
