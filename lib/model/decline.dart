...
class Decline {
  /// Returns a new [Decline] instance.
  Decline({
  ...
  /// **Note:** Decline tabs never display this tooltip in the signing interface.  Although you can technically set a value via the API for this tab, it will not be displayed to the recipient. 
  ///
  /// Please note: This property should have been non-nullable! Since the specification file
  /// does not include a default value (using the "default:" property), however, the generated
  /// source code must fall back to having a nullable type.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Decline &&
     ...
     other.declineReasonMetadata == declineReasonMetadata &&
  ...
  int get hashCode =>
    ...
    (declineReasonMetadata == null ? 0 : declineReasonMetadata!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (declineReason != null) {
      _json[r'declineReason'] = declineReason;
    }
    if (declineReasonMetadata != null) {
      _json[r'declineReasonMetadata'] = declineReasonMetadata;
    }
    if (documentId != null) {
  ...
  /// Returns a new [Decline] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static Decline? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Decline[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Decline[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return Decline(
        ...
        declineReasonMetadata: PropertyMetadata.fromJson(json[r'declineReasonMetadata']),
  ...
  static List<Decline>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Decline>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Decline.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, Decline> mapFromJson(dynamic json) {
    final map = <String, Decline>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Decline.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of Decline-objects as value to a dart map
  static Map<String, List<Decline>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Decline>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Decline.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
