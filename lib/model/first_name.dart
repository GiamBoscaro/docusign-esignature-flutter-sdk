...
class FirstName {
  /// Returns a new [FirstName] instance.
  FirstName({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FirstName &&
  ...
  /// Returns a new [FirstName] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FirstName? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FirstName[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FirstName[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<FirstName>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FirstName>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FirstName.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FirstName> mapFromJson(dynamic json) {
    final map = <String, FirstName>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FirstName.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FirstName-objects as value to a dart map
  static Map<String, List<FirstName>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FirstName>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FirstName.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
