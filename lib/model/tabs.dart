...
class Tabs {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Tabs &&
  ...
  /// Returns a new [Tabs] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static Tabs? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Tabs[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Tabs[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<Tabs>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Tabs>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Tabs.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, Tabs> mapFromJson(dynamic json) {
    final map = <String, Tabs>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Tabs.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of Tabs-objects as value to a dart map
  static Map<String, List<Tabs>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Tabs>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Tabs.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
