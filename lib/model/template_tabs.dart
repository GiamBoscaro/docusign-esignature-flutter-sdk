...
class TemplateTabs {
  /// Returns a new [TemplateTabs] instance.
  TemplateTabs({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TemplateTabs &&
  ...
  /// Returns a new [TemplateTabs] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TemplateTabs? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TemplateTabs[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TemplateTabs[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<TemplateTabs>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TemplateTabs>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TemplateTabs.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TemplateTabs> mapFromJson(dynamic json) {
    final map = <String, TemplateTabs>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TemplateTabs.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TemplateTabs-objects as value to a dart map
  static Map<String, List<TemplateTabs>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TemplateTabs>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TemplateTabs.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
