...
class LastName {
  /// Returns a new [LastName] instance.
  LastName({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LastName &&
  ...
  /// Returns a new [LastName] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static LastName? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LastName[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LastName[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<LastName>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <LastName>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LastName.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, LastName> mapFromJson(dynamic json) {
    final map = <String, LastName>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LastName.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of LastName-objects as value to a dart map
  static Map<String, List<LastName>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LastName>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LastName.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
