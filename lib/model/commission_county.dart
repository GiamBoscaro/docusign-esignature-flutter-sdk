...
class CommissionCounty {
  /// Returns a new [CommissionCounty] instance.
  CommissionCounty({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CommissionCounty &&
  ...
  /// Returns a new [CommissionCounty] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CommissionCounty? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CommissionCounty[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CommissionCounty[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CommissionCounty(
  ...
  static List<CommissionCounty>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CommissionCounty>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CommissionCounty.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CommissionCounty> mapFromJson(dynamic json) {
    final map = <String, CommissionCounty>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CommissionCounty.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CommissionCounty-objects as value to a dart map
  static Map<String, List<CommissionCounty>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CommissionCounty>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CommissionCounty.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
