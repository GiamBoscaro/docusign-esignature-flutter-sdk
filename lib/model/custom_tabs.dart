...
class CustomTabs {
  /// Returns a new [CustomTabs] instance.
  CustomTabs({
    this.anchor,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CustomTabs &&
     other.anchor == anchor &&
  ...
  /// Returns a new [CustomTabs] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CustomTabs? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CustomTabs[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CustomTabs[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CustomTabs>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CustomTabs>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CustomTabs.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CustomTabs> mapFromJson(dynamic json) {
    final map = <String, CustomTabs>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CustomTabs.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CustomTabs-objects as value to a dart map
  static Map<String, List<CustomTabs>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CustomTabs>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CustomTabs.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
