...
class ConsumerDisclosure {
  /// Returns a new [ConsumerDisclosure] instance.
  ConsumerDisclosure({
    this.accountEsignId,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ConsumerDisclosure &&
  ...
  /// Returns a new [ConsumerDisclosure] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ConsumerDisclosure? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ConsumerDisclosure[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ConsumerDisclosure[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ConsumerDisclosure>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ConsumerDisclosure>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ConsumerDisclosure.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ConsumerDisclosure> mapFromJson(dynamic json) {
    final map = <String, ConsumerDisclosure>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConsumerDisclosure.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ConsumerDisclosure-objects as value to a dart map
  static Map<String, List<ConsumerDisclosure>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ConsumerDisclosure>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConsumerDisclosure.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
