...
class TemplateRecipientTabs {
  /// Returns a new [TemplateRecipientTabs] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TemplateRecipientTabs &&
  ...
  /// Returns a new [TemplateRecipientTabs] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TemplateRecipientTabs? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TemplateRecipientTabs[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TemplateRecipientTabs[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TemplateRecipientTabs(
  ...
  static List<TemplateRecipientTabs>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TemplateRecipientTabs>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TemplateRecipientTabs.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TemplateRecipientTabs> mapFromJson(dynamic json) {
    final map = <String, TemplateRecipientTabs>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TemplateRecipientTabs.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TemplateRecipientTabs-objects as value to a dart map
  static Map<String, List<TemplateRecipientTabs>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TemplateRecipientTabs>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TemplateRecipientTabs.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
