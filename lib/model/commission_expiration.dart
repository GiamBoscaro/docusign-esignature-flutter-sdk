...
class CommissionExpiration {
  /// Returns a new [CommissionExpiration] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CommissionExpiration &&
  ...
  /// Returns a new [CommissionExpiration] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CommissionExpiration? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CommissionExpiration[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CommissionExpiration[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CommissionExpiration>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CommissionExpiration>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CommissionExpiration.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CommissionExpiration> mapFromJson(dynamic json) {
    final map = <String, CommissionExpiration>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CommissionExpiration.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CommissionExpiration-objects as value to a dart map
  static Map<String, List<CommissionExpiration>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CommissionExpiration>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CommissionExpiration.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
