...
class AccountBillingPlanResponse {
  /// Returns a new [AccountBillingPlanResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AccountBillingPlanResponse &&
  ...
  @override
  String toString() => 'AccountBillingPlanResponse[billingAddress=$billingAddress, billingAddressIsCreditCardAddress=$billingAddressIsCreditCardAddress, billingPlan=$billingPlan, creditCardInformation=$creditCardInformation, directDebitProcessorInformation=$directDebitProcessorInformation, downgradePlanInformation=$downgradePlanInformation, downgradeRequestInformation=$downgradeRequestInformation, entityInformation=$entityInformation, paymentMethod=$paymentMethod, paymentProcessorInformation=$paymentProcessorInformation, referralInformation=$referralInformation, successorPlans=$successorPlans, taxExemptId=$taxExemptId]';
  ...
  /// Returns a new [AccountBillingPlanResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AccountBillingPlanResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AccountBillingPlanResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AccountBillingPlanResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AccountBillingPlanResponse>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AccountBillingPlanResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AccountBillingPlanResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AccountBillingPlanResponse> mapFromJson(dynamic json) {
    final map = <String, AccountBillingPlanResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AccountBillingPlanResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AccountBillingPlanResponse-objects as value to a dart map
  static Map<String, List<AccountBillingPlanResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AccountBillingPlanResponse>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AccountBillingPlanResponse.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
