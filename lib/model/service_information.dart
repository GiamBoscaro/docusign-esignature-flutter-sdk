...
class ServiceInformation {
  /// Returns a new [ServiceInformation] instance.
  ServiceInformation({
    this.buildBranch,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ServiceInformation &&
  ...
  @override
  String toString() => 'ServiceInformation[buildBranch=$buildBranch, buildBranchDeployedDateTime=$buildBranchDeployedDateTime, buildSHA=$buildSHA, buildVersion=$buildVersion, linkedSites=$linkedSites, serviceVersions=$serviceVersions]';
  ...
  /// Returns a new [ServiceInformation] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ServiceInformation? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ServiceInformation[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ServiceInformation[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ServiceInformation>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ServiceInformation>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ServiceInformation.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ServiceInformation> mapFromJson(dynamic json) {
    final map = <String, ServiceInformation>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ServiceInformation.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ServiceInformation-objects as value to a dart map
  static Map<String, List<ServiceInformation>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ServiceInformation>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ServiceInformation.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
