...
class SenderCompany {
  /// Returns a new [SenderCompany] instance.
  SenderCompany({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SenderCompany &&
  ...
  /// Returns a new [SenderCompany] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SenderCompany? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SenderCompany[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SenderCompany[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SenderCompany>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SenderCompany>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SenderCompany.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SenderCompany> mapFromJson(dynamic json) {
    final map = <String, SenderCompany>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SenderCompany.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SenderCompany-objects as value to a dart map
  static Map<String, List<SenderCompany>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SenderCompany>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SenderCompany.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
