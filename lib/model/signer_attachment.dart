...
class SignerAttachment {
  /// Returns a new [SignerAttachment] instance.
  SignerAttachment({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SignerAttachment &&
  ...
  /// Returns a new [SignerAttachment] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SignerAttachment? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SignerAttachment[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SignerAttachment[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SignerAttachment>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SignerAttachment>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SignerAttachment.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SignerAttachment> mapFromJson(dynamic json) {
    final map = <String, SignerAttachment>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SignerAttachment.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SignerAttachment-objects as value to a dart map
  static Map<String, List<SignerAttachment>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SignerAttachment>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SignerAttachment.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
