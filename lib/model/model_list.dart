...
class ModelList {
  ...
  ModelList({
    ...
    this.listSelectedValueMetadata,
    this.localePolicy,
    this.locked,
    this.lockedMetadata,
    this.mergeField,
  ...
  bool operator ==(Object other) => identical(this, other) || other is ModelList &&
     ...
     other.listSelectedValueMetadata == listSelectedValueMetadata &&
  ...
  int get hashCode =>
    ...
    (listSelectedValueMetadata == null ? 0 : listSelectedValueMetadata!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (listSelectedValueMetadata != null) {
      _json[r'listSelectedValueMetadata'] = listSelectedValueMetadata;
    }
  ...
  static ModelList? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ModelList(
        ...
        listItems: ListItem.listFromJson(json[r'listItems']) ?? const [],
        listSelectedValue: mapValueOfType<String>(json, r'listSelectedValue'),
        listSelectedValueMetadata: PropertyMetadata.fromJson(json[r'listSelectedValueMetadata']),
