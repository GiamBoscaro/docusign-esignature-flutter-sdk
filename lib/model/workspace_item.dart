...
class WorkspaceItem {
  /// Returns a new [WorkspaceItem] instance.
  WorkspaceItem({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is WorkspaceItem &&
  ...
  /// Returns a new [WorkspaceItem] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static WorkspaceItem? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "WorkspaceItem[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "WorkspaceItem[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<WorkspaceItem>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <WorkspaceItem>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = WorkspaceItem.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, WorkspaceItem> mapFromJson(dynamic json) {
    final map = <String, WorkspaceItem>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = WorkspaceItem.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of WorkspaceItem-objects as value to a dart map
  static Map<String, List<WorkspaceItem>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<WorkspaceItem>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = WorkspaceItem.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
