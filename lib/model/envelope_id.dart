...
class EnvelopeId {
  /// Returns a new [EnvelopeId] instance.
  EnvelopeId({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EnvelopeId &&
  ...
  /// Returns a new [EnvelopeId] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EnvelopeId? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EnvelopeId[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EnvelopeId[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<EnvelopeId>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EnvelopeId>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EnvelopeId.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EnvelopeId> mapFromJson(dynamic json) {
    final map = <String, EnvelopeId>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvelopeId.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EnvelopeId-objects as value to a dart map
  static Map<String, List<EnvelopeId>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EnvelopeId>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvelopeId.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
