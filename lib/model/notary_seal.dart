...
class NotarySeal {
  /// Returns a new [NotarySeal] instance.
  NotarySeal({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is NotarySeal &&
  ...
  /// Returns a new [NotarySeal] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static NotarySeal? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "NotarySeal[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "NotarySeal[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<NotarySeal>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NotarySeal>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = NotarySeal.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, NotarySeal> mapFromJson(dynamic json) {
    final map = <String, NotarySeal>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = NotarySeal.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of NotarySeal-objects as value to a dart map
  static Map<String, List<NotarySeal>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<NotarySeal>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = NotarySeal.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
