...
class DateSigned {
  /// Returns a new [DateSigned] instance.
  DateSigned({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DateSigned &&
  ...
  /// Returns a new [DateSigned] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DateSigned? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DateSigned[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DateSigned[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DateSigned>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <DateSigned>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DateSigned.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DateSigned> mapFromJson(dynamic json) {
    final map = <String, DateSigned>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DateSigned.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of DateSigned-objects as value to a dart map
  static Map<String, List<DateSigned>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DateSigned>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DateSigned.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
