...
class EnvelopeEmailSettings {
  /// Returns a new [EnvelopeEmailSettings] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EnvelopeEmailSettings &&
  ...
  @override
  String toString() => 'EnvelopeEmailSettings[bccEmailAddresses=$bccEmailAddresses, replyEmailAddressOverride=$replyEmailAddressOverride, replyEmailNameOverride=$replyEmailNameOverride]';
  ...
  /// Returns a new [EnvelopeEmailSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EnvelopeEmailSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EnvelopeEmailSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EnvelopeEmailSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<EnvelopeEmailSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EnvelopeEmailSettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EnvelopeEmailSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EnvelopeEmailSettings> mapFromJson(dynamic json) {
    final map = <String, EnvelopeEmailSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvelopeEmailSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EnvelopeEmailSettings-objects as value to a dart map
  static Map<String, List<EnvelopeEmailSettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EnvelopeEmailSettings>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvelopeEmailSettings.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
