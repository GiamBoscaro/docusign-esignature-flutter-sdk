...
class Workspaces {
  /// Returns a new [Workspaces] instance.
  Workspaces({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Workspaces &&
  ...
  /// Returns a new [Workspaces] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static Workspaces? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Workspaces[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Workspaces[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<Workspaces>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Workspaces>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Workspaces.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, Workspaces> mapFromJson(dynamic json) {
    final map = <String, Workspaces>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Workspaces.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of Workspaces-objects as value to a dart map
  static Map<String, List<Workspaces>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Workspaces>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Workspaces.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
