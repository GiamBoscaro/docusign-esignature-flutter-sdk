...
class SignHere {
  /// Returns a new [SignHere] instance.
  SignHere({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SignHere &&
     ...
     other.scaleValueMetadata == scaleValueMetadata &&
  ...
  int get hashCode =>
    ...
    (handDrawRequired == null ? 0 : handDrawRequired!.hashCode) +
    (height == null ? 0 : height!.hashCode) +
    (heightMetadata == null ? 0 : heightMetadata!.hashCode) +
    (isSealSignTab == null ? 0 : isSealSignTab!.hashCode) +
    ...
    (scaleValueMetadata == null ? 0 : scaleValueMetadata!.hashCode) +
    (smartContractInformation == null ? 0 : smartContractInformation!.hashCode) +
    (source_ == null ? 0 : source_!.hashCode) +
    (stamp == null ? 0 : stamp!.hashCode) +
  ...
  @override
  String toString() => 'SignHere[anchorAllowWhiteSpaceInCharacters=$anchorAllowWhiteSpaceInCharacters, anchorAllowWhiteSpaceInCharactersMetadata=$anchorAllowWhiteSpaceInCharactersMetadata, anchorCaseSensitive=$anchorCaseSensitive, anchorCaseSensitiveMetadata=$anchorCaseSensitiveMetadata, anchorHorizontalAlignment=$anchorHorizontalAlignment, anchorHorizontalAlignmentMetadata=$anchorHorizontalAlignmentMetadata, anchorIgnoreIfNotPresent=$anchorIgnoreIfNotPresent, anchorIgnoreIfNotPresentMetadata=$anchorIgnoreIfNotPresentMetadata, anchorMatchWholeWord=$anchorMatchWholeWord, anchorMatchWholeWordMetadata=$anchorMatchWholeWordMetadata, anchorString=$anchorString, anchorStringMetadata=$anchorStringMetadata, anchorTabProcessorVersion=$anchorTabProcessorVersion, anchorTabProcessorVersionMetadata=$anchorTabProcessorVersionMetadata, anchorUnits=$anchorUnits, anchorUnitsMetadata=$anchorUnitsMetadata, anchorXOffset=$anchorXOffset, anchorXOffsetMetadata=$anchorXOffsetMetadata, anchorYOffset=$anchorYOffset, anchorYOffsetMetadata=$anchorYOffsetMetadata, caption=$caption, captionMetadata=$captionMetadata, conditionalParentLabel=$conditionalParentLabel, conditionalParentLabelMetadata=$conditionalParentLabelMetadata, conditionalParentValue=$conditionalParentValue, conditionalParentValueMetadata=$conditionalParentValueMetadata, customTabId=$customTabId, customTabIdMetadata=$customTabIdMetadata, documentId=$documentId, documentIdMetadata=$documentIdMetadata, errorDetails=$errorDetails, formOrder=$formOrder, formOrderMetadata=$formOrderMetadata, formPageLabel=$formPageLabel, formPageLabelMetadata=$formPageLabelMetadata, formPageNumber=$formPageNumber, formPageNumberMetadata=$formPageNumberMetadata, handDrawRequired=$handDrawRequired, height=$height, heightMetadata=$heightMetadata, isSealSignTab=$isSealSignTab, mergeField=$mergeField, mergeFieldXml=$mergeFieldXml, name=$name, nameMetadata=$nameMetadata, optional=$optional, optionalMetadata=$optionalMetadata, pageNumber=$pageNumber, pageNumberMetadata=$pageNumberMetadata, recipientId=$recipientId, recipientIdGuid=$recipientIdGuid, recipientIdGuidMetadata=$recipientIdGuidMetadata, recipientIdMetadata=$recipientIdMetadata, scaleValue=$scaleValue, scaleValueMetadata=$scaleValueMetadata, smartContractInformation=$smartContractInformation, source_=$source_, stamp=$stamp, stampType=$stampType, stampTypeMetadata=$stampTypeMetadata, status=$status, statusMetadata=$statusMetadata, tabGroupLabels=$tabGroupLabels, tabGroupLabelsMetadata=$tabGroupLabelsMetadata, tabId=$tabId, tabIdMetadata=$tabIdMetadata, tabLabel=$tabLabel, tabLabelMetadata=$tabLabelMetadata, tabOrder=$tabOrder, tabOrderMetadata=$tabOrderMetadata, tabType=$tabType, tabTypeMetadata=$tabTypeMetadata, templateLocked=$templateLocked, templateLockedMetadata=$templateLockedMetadata, templateRequired=$templateRequired, templateRequiredMetadata=$templateRequiredMetadata, tooltip=$tooltip, toolTipMetadata=$toolTipMetadata, width=$width, widthMetadata=$widthMetadata, xPosition=$xPosition, xPositionMetadata=$xPositionMetadata, yPosition=$yPosition, yPositionMetadata=$yPositionMetadata]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (handDrawRequired != null) {
      _json[r'handDrawRequired'] = handDrawRequired;
    }
    if (height != null) {
    ...
    if (isSealSignTab != null) {
      _json[r'isSealSignTab'] = isSealSignTab;
    }
    if (mergeField != null) {
    ...
    if (optional != null) {
      _json[r'optional'] = optional;
    }
    if (optionalMetadata != null) {
      _json[r'optionalMetadata'] = optionalMetadata;
    }
    if (pageNumber != null) {
    ...
    if (scaleValueMetadata != null) {
      _json[r'scaleValueMetadata'] = scaleValueMetadata;
    }
  ...
  /// Returns a new [SignHere] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SignHere? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SignHere[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SignHere[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return SignHere(
        ...
        handDrawRequired: mapValueOfType<String>(json, r'handDrawRequired'),
        height: mapValueOfType<String>(json, r'height'),
        heightMetadata: PropertyMetadata.fromJson(json[r'heightMetadata']),
        isSealSignTab: mapValueOfType<String>(json, r'isSealSignTab'),
        ...
        optional: mapValueOfType<String>(json, r'optional'),
        optionalMetadata: PropertyMetadata.fromJson(json[r'optionalMetadata']),
        ...
        scaleValueMetadata: PropertyMetadata.fromJson(json[r'scaleValueMetadata']),
        smartContractInformation: SmartContractInformation.fromJson(json[r'smartContractInformation']),
        source_: mapValueOfType<String>(json, r'source'),
        stamp: Stamp.fromJson(json[r'stamp']),
  ...
  static List<SignHere>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SignHere>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SignHere.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SignHere> mapFromJson(dynamic json) {
    final map = <String, SignHere>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SignHere.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SignHere-objects as value to a dart map
  static Map<String, List<SignHere>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SignHere>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SignHere.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
