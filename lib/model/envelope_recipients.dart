...
class EnvelopeRecipients {
  /// Returns a new [EnvelopeRecipients] instance.
  EnvelopeRecipients({
    this.agents = const [],
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EnvelopeRecipients &&
     other.agents == agents &&
  ...
  /// Returns a new [EnvelopeRecipients] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EnvelopeRecipients? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EnvelopeRecipients[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EnvelopeRecipients[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<EnvelopeRecipients>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EnvelopeRecipients>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EnvelopeRecipients.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EnvelopeRecipients> mapFromJson(dynamic json) {
    final map = <String, EnvelopeRecipients>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvelopeRecipients.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EnvelopeRecipients-objects as value to a dart map
  static Map<String, List<EnvelopeRecipients>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EnvelopeRecipients>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvelopeRecipients.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
