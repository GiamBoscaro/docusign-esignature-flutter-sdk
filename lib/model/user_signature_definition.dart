...
class UserSignatureDefinition {
  /// Returns a new [UserSignatureDefinition] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UserSignatureDefinition &&
  ...
  @override
  String toString() => 'UserSignatureDefinition[dateStampProperties=$dateStampProperties, disallowUserResizeStamp=$disallowUserResizeStamp, externalID=$externalID, imageType=$imageType, isDefault=$isDefault, nrdsId=$nrdsId, nrdsLastName=$nrdsLastName, phoneticName=$phoneticName, signatureFont=$signatureFont, signatureId=$signatureId, signatureInitials=$signatureInitials, signatureName=$signatureName, signatureType=$signatureType, stampFormat=$stampFormat, stampSizeMM=$stampSizeMM]';
  ...
  /// Returns a new [UserSignatureDefinition] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UserSignatureDefinition? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UserSignatureDefinition[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UserSignatureDefinition[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UserSignatureDefinition>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UserSignatureDefinition>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UserSignatureDefinition.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UserSignatureDefinition> mapFromJson(dynamic json) {
    final map = <String, UserSignatureDefinition>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UserSignatureDefinition.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UserSignatureDefinition-objects as value to a dart map
  static Map<String, List<UserSignatureDefinition>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UserSignatureDefinition>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UserSignatureDefinition.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
