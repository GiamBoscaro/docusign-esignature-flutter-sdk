...
class PaymentGatewayAccounts {
  /// Returns a new [PaymentGatewayAccounts] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PaymentGatewayAccounts &&
  ...
  /// Returns a new [PaymentGatewayAccounts] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PaymentGatewayAccounts? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PaymentGatewayAccounts[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PaymentGatewayAccounts[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PaymentGatewayAccounts>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PaymentGatewayAccounts>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PaymentGatewayAccounts.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PaymentGatewayAccounts> mapFromJson(dynamic json) {
    final map = <String, PaymentGatewayAccounts>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PaymentGatewayAccounts.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PaymentGatewayAccounts-objects as value to a dart map
  static Map<String, List<PaymentGatewayAccounts>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PaymentGatewayAccounts>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PaymentGatewayAccounts.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
