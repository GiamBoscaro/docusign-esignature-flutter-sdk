...
class SmartSectionDisplaySettings {
  /// Returns a new [SmartSectionDisplaySettings] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SmartSectionDisplaySettings &&
  ...
  /// Returns a new [SmartSectionDisplaySettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SmartSectionDisplaySettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SmartSectionDisplaySettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SmartSectionDisplaySettings[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return SmartSectionDisplaySettings(
        ...
        collapsibleSettings: SmartSectionCollapsibleDisplaySettings.fromJson(json[r'collapsibleSettings']),
  ...
  static List<SmartSectionDisplaySettings>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SmartSectionDisplaySettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SmartSectionDisplaySettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SmartSectionDisplaySettings> mapFromJson(dynamic json) {
    final map = <String, SmartSectionDisplaySettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SmartSectionDisplaySettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SmartSectionDisplaySettings-objects as value to a dart map
  static Map<String, List<SmartSectionDisplaySettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SmartSectionDisplaySettings>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SmartSectionDisplaySettings.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
