...
class InitialHere {
  /// Returns a new [InitialHere] instance.
  InitialHere({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InitialHere &&
  ...
  /// Returns a new [InitialHere] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static InitialHere? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InitialHere[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InitialHere[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<InitialHere>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InitialHere>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InitialHere.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, InitialHere> mapFromJson(dynamic json) {
    final map = <String, InitialHere>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = InitialHere.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of InitialHere-objects as value to a dart map
  static Map<String, List<InitialHere>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InitialHere>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = InitialHere.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
