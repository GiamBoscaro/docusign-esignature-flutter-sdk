...
class AccountSignature {
  /// Returns a new [AccountSignature] instance.
  AccountSignature({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AccountSignature &&
  ...
  /// Returns a new [AccountSignature] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AccountSignature? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AccountSignature[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AccountSignature[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AccountSignature>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AccountSignature>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AccountSignature.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AccountSignature> mapFromJson(dynamic json) {
    final map = <String, AccountSignature>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AccountSignature.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AccountSignature-objects as value to a dart map
  static Map<String, List<AccountSignature>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AccountSignature>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AccountSignature.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
