...
class CommissionState {
  /// Returns a new [CommissionState] instance.
  CommissionState({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CommissionState &&
  ...
  /// Returns a new [CommissionState] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CommissionState? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CommissionState[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CommissionState[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CommissionState>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CommissionState>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CommissionState.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CommissionState> mapFromJson(dynamic json) {
    final map = <String, CommissionState>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CommissionState.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CommissionState-objects as value to a dart map
  static Map<String, List<CommissionState>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CommissionState>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CommissionState.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
