...
class NotaryJournal {
  /// Returns a new [NotaryJournal] instance.
  NotaryJournal({
    this.createdDate,
    this.documentName,
    this.jurisdiction,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is NotaryJournal &&
  ...
  @override
  String toString() => 'NotaryJournal[createdDate=$createdDate, documentName=$documentName, jurisdiction=$jurisdiction, notaryJournalId=$notaryJournalId, notaryJournalMetaData=$notaryJournalMetaData, signerName=$signerName]';
  ...
  /// Returns a new [NotaryJournal] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static NotaryJournal? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "NotaryJournal[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "NotaryJournal[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<NotaryJournal>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NotaryJournal>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = NotaryJournal.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, NotaryJournal> mapFromJson(dynamic json) {
    final map = <String, NotaryJournal>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = NotaryJournal.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of NotaryJournal-objects as value to a dart map
  static Map<String, List<NotaryJournal>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<NotaryJournal>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = NotaryJournal.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
