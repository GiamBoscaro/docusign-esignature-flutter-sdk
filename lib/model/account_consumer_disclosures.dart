...
class AccountConsumerDisclosures {
  /// Returns a new [AccountConsumerDisclosures] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AccountConsumerDisclosures &&
  ...
  /// Returns a new [AccountConsumerDisclosures] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AccountConsumerDisclosures? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AccountConsumerDisclosures[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AccountConsumerDisclosures[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AccountConsumerDisclosures>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AccountConsumerDisclosures>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AccountConsumerDisclosures.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AccountConsumerDisclosures> mapFromJson(dynamic json) {
    final map = <String, AccountConsumerDisclosures>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AccountConsumerDisclosures.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AccountConsumerDisclosures-objects as value to a dart map
  static Map<String, List<AccountConsumerDisclosures>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AccountConsumerDisclosures>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AccountConsumerDisclosures.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
