...
class SenderName {
  /// Returns a new [SenderName] instance.
  SenderName({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SenderName &&
  ...
  /// Returns a new [SenderName] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SenderName? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SenderName[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SenderName[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SenderName>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SenderName>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SenderName.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SenderName> mapFromJson(dynamic json) {
    final map = <String, SenderName>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SenderName.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SenderName-objects as value to a dart map
  static Map<String, List<SenderName>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SenderName>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SenderName.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
