...
class Envelopes {
  /// Returns a new [Envelopes] instance.
  Envelopes({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Envelopes &&
  ...
  /// Returns a new [Envelopes] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static Envelopes? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Envelopes[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Envelopes[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<Envelopes>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Envelopes>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Envelopes.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, Envelopes> mapFromJson(dynamic json) {
    final map = <String, Envelopes>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Envelopes.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of Envelopes-objects as value to a dart map
  static Map<String, List<Envelopes>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Envelopes>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Envelopes.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
