...
class SmartSection {
  /// Returns a new [SmartSection] instance.
  SmartSection({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SmartSection &&
  ...
  /// Returns a new [SmartSection] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SmartSection? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SmartSection[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SmartSection[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return SmartSection(
        ...
        displaySettings: SmartSectionDisplaySettings.fromJson(json[r'displaySettings']),
        ...
        endPosition: SmartSectionAnchorPosition.fromJson(json[r'endPosition']),
        ...
        startPosition: SmartSectionAnchorPosition.fromJson(json[r'startPosition']),
  ...
  static List<SmartSection>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SmartSection>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SmartSection.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SmartSection> mapFromJson(dynamic json) {
    final map = <String, SmartSection>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SmartSection.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SmartSection-objects as value to a dart map
  static Map<String, List<SmartSection>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SmartSection>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SmartSection.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
