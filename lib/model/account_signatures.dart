...
class AccountSignatures {
  /// Returns a new [AccountSignatures] instance.
  AccountSignatures({
  ...
  /// 
  List<SignatureUser> signatureUsers;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AccountSignatures &&
  ...
  /// Returns a new [AccountSignatures] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AccountSignatures? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AccountSignatures[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AccountSignatures[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return AccountSignatures(
        ...
        signatureGroups: SignatureGroup.listFromJson(json[r'signatureGroups']) ?? const [],
        ...
        signatureUsers: SignatureUser.listFromJson(json[r'signatureUsers']) ?? const [],
  ...
  static List<AccountSignatures>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AccountSignatures>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AccountSignatures.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AccountSignatures> mapFromJson(dynamic json) {
    final map = <String, AccountSignatures>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AccountSignatures.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AccountSignatures-objects as value to a dart map
  static Map<String, List<AccountSignatures>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AccountSignatures>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AccountSignatures.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
