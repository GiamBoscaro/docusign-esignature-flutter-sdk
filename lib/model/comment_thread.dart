...
class CommentThread {
  /// Returns a new [CommentThread] instance.
  CommentThread({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CommentThread &&
  ...
  /// Returns a new [CommentThread] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CommentThread? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CommentThread[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CommentThread[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CommentThread>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CommentThread>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CommentThread.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CommentThread> mapFromJson(dynamic json) {
    final map = <String, CommentThread>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CommentThread.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CommentThread-objects as value to a dart map
  static Map<String, List<CommentThread>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CommentThread>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CommentThread.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
