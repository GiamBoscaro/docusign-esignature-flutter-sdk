...
class Checkbox {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Checkbox &&
     ...
     other.selectedOriginal == selectedOriginal &&
     other.selectedOriginalMetadata == selectedOriginalMetadata &&
     other.shared == shared &&
  ...
  int get hashCode =>
    ...
    (selectedOriginal == null ? 0 : selectedOriginal!.hashCode) +
    (selectedOriginalMetadata == null ? 0 : selectedOriginalMetadata!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (selectedOriginal != null) {
      _json[r'selectedOriginal'] = selectedOriginal;
    }
    if (selectedOriginalMetadata != null) {
      _json[r'selectedOriginalMetadata'] = selectedOriginalMetadata;
    }
    if (shared != null) {
  ...
  /// Returns a new [Checkbox] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static Checkbox? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Checkbox[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Checkbox[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return Checkbox(
        ...
        selectedOriginal: mapValueOfType<String>(json, r'selectedOriginal'),
        selectedOriginalMetadata: PropertyMetadata.fromJson(json[r'selectedOriginalMetadata']),
  ...
  static List<Checkbox>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Checkbox>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Checkbox.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, Checkbox> mapFromJson(dynamic json) {
    final map = <String, Checkbox>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Checkbox.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of Checkbox-objects as value to a dart map
  static Map<String, List<Checkbox>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Checkbox>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Checkbox.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
