...
class ConnectCustomConfiguration {
  /// Returns a new [ConnectCustomConfiguration] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ConnectCustomConfiguration &&
  ...
  /// Returns a new [ConnectCustomConfiguration] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ConnectCustomConfiguration? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ConnectCustomConfiguration[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ConnectCustomConfiguration[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ConnectCustomConfiguration>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ConnectCustomConfiguration>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ConnectCustomConfiguration.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ConnectCustomConfiguration> mapFromJson(dynamic json) {
    final map = <String, ConnectCustomConfiguration>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConnectCustomConfiguration.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ConnectCustomConfiguration-objects as value to a dart map
  static Map<String, List<ConnectCustomConfiguration>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ConnectCustomConfiguration>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConnectCustomConfiguration.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
