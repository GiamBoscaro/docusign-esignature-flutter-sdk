...
class EnvelopePublishTransaction {
  /// Returns a new [EnvelopePublishTransaction] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EnvelopePublishTransaction &&
  ...
  /// Returns a new [EnvelopePublishTransaction] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EnvelopePublishTransaction? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EnvelopePublishTransaction[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EnvelopePublishTransaction[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<EnvelopePublishTransaction>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EnvelopePublishTransaction>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EnvelopePublishTransaction.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EnvelopePublishTransaction> mapFromJson(dynamic json) {
    final map = <String, EnvelopePublishTransaction>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvelopePublishTransaction.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EnvelopePublishTransaction-objects as value to a dart map
  static Map<String, List<EnvelopePublishTransaction>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EnvelopePublishTransaction>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvelopePublishTransaction.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
