...
class FullName {
  /// Returns a new [FullName] instance.
  FullName({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FullName &&
  ...
  /// Returns a new [FullName] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FullName? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FullName[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FullName[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<FullName>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FullName>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FullName.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FullName> mapFromJson(dynamic json) {
    final map = <String, FullName>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FullName.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FullName-objects as value to a dart map
  static Map<String, List<FullName>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FullName>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FullName.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
