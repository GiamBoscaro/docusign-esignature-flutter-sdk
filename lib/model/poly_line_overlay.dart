...
class PolyLineOverlay {
  /// Returns a new [PolyLineOverlay] instance.
  PolyLineOverlay({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PolyLineOverlay &&
     ...
     other.graphicsContext == graphicsContext &&
     other.height == height &&
     ...
     other.overlayType == overlayType &&
     other.overlayTypeMetadata == overlayTypeMetadata &&
  ...
  int get hashCode =>
    ...
    (graphicsContext == null ? 0 : graphicsContext!.hashCode) +
    ...
    (overlayType == null ? 0 : overlayType!.hashCode) +
    (overlayTypeMetadata == null ? 0 : overlayTypeMetadata!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (graphicsContext != null) {
      _json[r'graphicsContext'] = graphicsContext;
    }
    if (height != null) {
    ...
    if (overlayType != null) {
      _json[r'overlayType'] = overlayType;
    }
    if (overlayTypeMetadata != null) {
      _json[r'overlayTypeMetadata'] = overlayTypeMetadata;
    }
    if (pageNumber != null) {
  ...
  /// Returns a new [PolyLineOverlay] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PolyLineOverlay? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PolyLineOverlay[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PolyLineOverlay[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return PolyLineOverlay(
        ...
        graphicsContext: GraphicsContext.fromJson(json[r'graphicsContext']),
        ...
        overlayType: mapValueOfType<String>(json, r'overlayType'),
        overlayTypeMetadata: PropertyMetadata.fromJson(json[r'overlayTypeMetadata']),
        pageNumber: mapValueOfType<String>(json, r'pageNumber'),
        pageNumberMetadata: PropertyMetadata.fromJson(json[r'pageNumberMetadata']),
        polyLines: PolyLine.listFromJson(json[r'polyLines']) ?? const [],
  ...
  static List<PolyLineOverlay>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PolyLineOverlay>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PolyLineOverlay.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PolyLineOverlay> mapFromJson(dynamic json) {
    final map = <String, PolyLineOverlay>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PolyLineOverlay.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PolyLineOverlay-objects as value to a dart map
  static Map<String, List<PolyLineOverlay>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PolyLineOverlay>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PolyLineOverlay.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
