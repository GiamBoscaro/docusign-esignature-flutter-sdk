...
class TemplateDocumentTabs {
  /// Returns a new [TemplateDocumentTabs] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TemplateDocumentTabs &&
  ...
  /// Returns a new [TemplateDocumentTabs] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TemplateDocumentTabs? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TemplateDocumentTabs[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TemplateDocumentTabs[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<TemplateDocumentTabs>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TemplateDocumentTabs>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TemplateDocumentTabs.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TemplateDocumentTabs> mapFromJson(dynamic json) {
    final map = <String, TemplateDocumentTabs>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TemplateDocumentTabs.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TemplateDocumentTabs-objects as value to a dart map
  static Map<String, List<TemplateDocumentTabs>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TemplateDocumentTabs>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TemplateDocumentTabs.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
