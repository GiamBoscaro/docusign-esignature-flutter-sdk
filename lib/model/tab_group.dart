...
class TabGroup {
  /// Returns a new [TabGroup] instance.
  TabGroup({
    ...
    this.groupLabel,
    this.groupLabelMetadata,
    this.groupRule,
    this.groupRuleMetadata,
    this.height,
    this.heightMetadata,
    this.maximumAllowed,
    this.maximumAllowedMetadata,
    this.mergeField,
    this.mergeFieldXml,
    this.minimumRequired,
    this.minimumRequiredMetadata,
    this.pageNumber,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TabGroup &&
     ...
     other.groupLabelMetadata == groupLabelMetadata &&
     other.groupRule == groupRule &&
     other.groupRuleMetadata == groupRuleMetadata &&
     other.height == height &&
     other.heightMetadata == heightMetadata &&
     other.maximumAllowed == maximumAllowed &&
     other.maximumAllowedMetadata == maximumAllowedMetadata &&
     other.mergeField == mergeField &&
     other.mergeFieldXml == mergeFieldXml &&
     other.minimumRequired == minimumRequired &&
     other.minimumRequiredMetadata == minimumRequiredMetadata &&
     ...
     other.tabScope == tabScope &&
     other.tabScopeMetadata == tabScopeMetadata &&
  ...
  int get hashCode =>
    ...
    (groupLabel == null ? 0 : groupLabel!.hashCode) +
    (groupLabelMetadata == null ? 0 : groupLabelMetadata!.hashCode) +
    (groupRule == null ? 0 : groupRule!.hashCode) +
    (groupRuleMetadata == null ? 0 : groupRuleMetadata!.hashCode) +
    (height == null ? 0 : height!.hashCode) +
    (heightMetadata == null ? 0 : heightMetadata!.hashCode) +
    (maximumAllowed == null ? 0 : maximumAllowed!.hashCode) +
    (maximumAllowedMetadata == null ? 0 : maximumAllowedMetadata!.hashCode) +
    (mergeField == null ? 0 : mergeField!.hashCode) +
    (mergeFieldXml == null ? 0 : mergeFieldXml!.hashCode) +
    (minimumRequired == null ? 0 : minimumRequired!.hashCode) +
    (minimumRequiredMetadata == null ? 0 : minimumRequiredMetadata!.hashCode) +
    ...
    (tabScope == null ? 0 : tabScope!.hashCode) +
    (tabScopeMetadata == null ? 0 : tabScopeMetadata!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (groupLabel != null) {
      _json[r'groupLabel'] = groupLabel;
    }
    if (groupLabelMetadata != null) {
      _json[r'groupLabelMetadata'] = groupLabelMetadata;
    }
    if (groupRule != null) {
      _json[r'groupRule'] = groupRule;
    }
    if (groupRuleMetadata != null) {
      _json[r'groupRuleMetadata'] = groupRuleMetadata;
    }
    if (height != null) {
    ...
    if (maximumAllowed != null) {
      _json[r'maximumAllowed'] = maximumAllowed;
    }
    if (maximumAllowedMetadata != null) {
      _json[r'maximumAllowedMetadata'] = maximumAllowedMetadata;
    }
    if (mergeField != null) {
    ...
    if (minimumRequired != null) {
      _json[r'minimumRequired'] = minimumRequired;
    }
    if (minimumRequiredMetadata != null) {
      _json[r'minimumRequiredMetadata'] = minimumRequiredMetadata;
    }
    if (pageNumber != null) {
    ...
    if (tabScope != null) {
      _json[r'tabScope'] = tabScope;
    }
    if (tabScopeMetadata != null) {
      _json[r'tabScopeMetadata'] = tabScopeMetadata;
    }
    if (tabType != null) {
  ...
  /// Returns a new [TabGroup] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TabGroup? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TabGroup[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TabGroup[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return TabGroup(
        ...
        groupLabel: mapValueOfType<String>(json, r'groupLabel'),
        groupLabelMetadata: PropertyMetadata.fromJson(json[r'groupLabelMetadata']),
        groupRule: mapValueOfType<String>(json, r'groupRule'),
        groupRuleMetadata: PropertyMetadata.fromJson(json[r'groupRuleMetadata']),
        height: mapValueOfType<String>(json, r'height'),
        heightMetadata: PropertyMetadata.fromJson(json[r'heightMetadata']),
        maximumAllowed: mapValueOfType<String>(json, r'maximumAllowed'),
        maximumAllowedMetadata: PropertyMetadata.fromJson(json[r'maximumAllowedMetadata']),
        mergeField: MergeField.fromJson(json[r'mergeField']),
        mergeFieldXml: mapValueOfType<String>(json, r'mergeFieldXml'),
        minimumRequired: mapValueOfType<String>(json, r'minimumRequired'),
        minimumRequiredMetadata: PropertyMetadata.fromJson(json[r'minimumRequiredMetadata']),
        ...
        tabScope: mapValueOfType<String>(json, r'tabScope'),
        tabScopeMetadata: PropertyMetadata.fromJson(json[r'tabScopeMetadata']),
  ...
  static List<TabGroup>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TabGroup>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TabGroup.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TabGroup> mapFromJson(dynamic json) {
    final map = <String, TabGroup>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TabGroup.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TabGroup-objects as value to a dart map
  static Map<String, List<TabGroup>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TabGroup>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TabGroup.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
