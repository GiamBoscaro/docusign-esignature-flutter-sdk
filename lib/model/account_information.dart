...
class AccountInformation {
  /// Returns a new [AccountInformation] instance.
  AccountInformation({
    this.accountIdGuid,
    this.accountName,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AccountInformation &&
  ...
  /// Returns a new [AccountInformation] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AccountInformation? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AccountInformation[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AccountInformation[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AccountInformation>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AccountInformation>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AccountInformation.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AccountInformation> mapFromJson(dynamic json) {
    final map = <String, AccountInformation>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AccountInformation.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AccountInformation-objects as value to a dart map
  static Map<String, List<AccountInformation>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AccountInformation>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AccountInformation.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
