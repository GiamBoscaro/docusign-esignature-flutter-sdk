...
class Participant {
  ...
  bool operator ==(Object other) => identical(this, other) || other is Participant &&
     ...
     other.participateFor == participateFor &&
     other.participateForGuid == participateForGuid &&
  ...
  int get hashCode =>
    ...
    (participateFor == null ? 0 : participateFor!.hashCode) +
    (participateForGuid == null ? 0 : participateForGuid!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (participateFor != null) {
      _json[r'participateFor'] = participateFor;
    }
    if (participateForGuid != null) {
      _json[r'participateForGuid'] = participateForGuid;
    }
  ...
  static Participant? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Participant(
        ...
        participateFor: mapValueOfType<String>(json, r'participateFor'),
        participateForGuid: mapValueOfType<String>(json, r'participateForGuid'),
  ...
  static Map<String, List<Participant>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Participant.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
