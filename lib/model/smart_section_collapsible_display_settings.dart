...
class SmartSectionCollapsibleDisplaySettings {
  /// Returns a new [SmartSectionCollapsibleDisplaySettings] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SmartSectionCollapsibleDisplaySettings &&
  ...
  @override
  String toString() => 'SmartSectionCollapsibleDisplaySettings[arrowClosed=$arrowClosed, arrowColor=$arrowColor, arrowLocation=$arrowLocation, arrowOpen=$arrowOpen, arrowSize=$arrowSize, arrowStyle=$arrowStyle, containerStyle=$containerStyle, labelStyle=$labelStyle, onlyArrowIsClickable=$onlyArrowIsClickable, outerLabelAndArrowStyle=$outerLabelAndArrowStyle]';
  ...
  /// Returns a new [SmartSectionCollapsibleDisplaySettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SmartSectionCollapsibleDisplaySettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SmartSectionCollapsibleDisplaySettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SmartSectionCollapsibleDisplaySettings[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SmartSectionCollapsibleDisplaySettings>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SmartSectionCollapsibleDisplaySettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SmartSectionCollapsibleDisplaySettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SmartSectionCollapsibleDisplaySettings> mapFromJson(dynamic json) {
    final map = <String, SmartSectionCollapsibleDisplaySettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SmartSectionCollapsibleDisplaySettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SmartSectionCollapsibleDisplaySettings-objects as value to a dart map
  static Map<String, List<SmartSectionCollapsibleDisplaySettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SmartSectionCollapsibleDisplaySettings>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SmartSectionCollapsibleDisplaySettings.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
