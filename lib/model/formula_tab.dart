...
class FormulaTab {
  /// Returns a new [FormulaTab] instance.
  FormulaTab({
    ...
    this.roundDecimalPlacesMetadata,
    this.senderRequired,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FormulaTab &&
     ...
     other.formulaMetadata == formulaMetadata &&
     other.height == height &&
     other.heightMetadata == heightMetadata &&
     other.hidden == hidden &&
     other.hiddenMetadata == hiddenMetadata &&
     other.isPaymentAmountMetadata == isPaymentAmountMetadata &&
     other.italic == italic &&
     ...
     other.roundDecimalPlaces == roundDecimalPlaces &&
     other.roundDecimalPlacesMetadata == roundDecimalPlacesMetadata &&
  ...
  int get hashCode =>
    ...
    (formulaMetadata == null ? 0 : formulaMetadata!.hashCode) +
    (height == null ? 0 : height!.hashCode) +
    (heightMetadata == null ? 0 : heightMetadata!.hashCode) +
    (hidden == null ? 0 : hidden!.hashCode) +
    (hiddenMetadata == null ? 0 : hiddenMetadata!.hashCode) +
    (isPaymentAmountMetadata == null ? 0 : isPaymentAmountMetadata!.hashCode) +
    ...
    (roundDecimalPlaces == null ? 0 : roundDecimalPlaces!.hashCode) +
    (roundDecimalPlacesMetadata == null ? 0 : roundDecimalPlacesMetadata!.hashCode) +
  ...
  @override
  String toString() => 'FormulaTab[anchorAllowWhiteSpaceInCharacters=$anchorAllowWhiteSpaceInCharacters, anchorAllowWhiteSpaceInCharactersMetadata=$anchorAllowWhiteSpaceInCharactersMetadata, anchorCaseSensitive=$anchorCaseSensitive, anchorCaseSensitiveMetadata=$anchorCaseSensitiveMetadata, anchorHorizontalAlignment=$anchorHorizontalAlignment, anchorHorizontalAlignmentMetadata=$anchorHorizontalAlignmentMetadata, anchorIgnoreIfNotPresent=$anchorIgnoreIfNotPresent, anchorIgnoreIfNotPresentMetadata=$anchorIgnoreIfNotPresentMetadata, anchorMatchWholeWord=$anchorMatchWholeWord, anchorMatchWholeWordMetadata=$anchorMatchWholeWordMetadata, anchorString=$anchorString, anchorStringMetadata=$anchorStringMetadata, anchorTabProcessorVersion=$anchorTabProcessorVersion, anchorTabProcessorVersionMetadata=$anchorTabProcessorVersionMetadata, anchorUnits=$anchorUnits, anchorUnitsMetadata=$anchorUnitsMetadata, anchorXOffset=$anchorXOffset, anchorXOffsetMetadata=$anchorXOffsetMetadata, anchorYOffset=$anchorYOffset, anchorYOffsetMetadata=$anchorYOffsetMetadata, bold=$bold, boldMetadata=$boldMetadata, caption=$caption, captionMetadata=$captionMetadata, concealValueOnDocument=$concealValueOnDocument, concealValueOnDocumentMetadata=$concealValueOnDocumentMetadata, conditionalParentLabel=$conditionalParentLabel, conditionalParentLabelMetadata=$conditionalParentLabelMetadata, conditionalParentValue=$conditionalParentValue, conditionalParentValueMetadata=$conditionalParentValueMetadata, customTabId=$customTabId, customTabIdMetadata=$customTabIdMetadata, disableAutoSize=$disableAutoSize, disableAutoSizeMetadata=$disableAutoSizeMetadata, documentId=$documentId, documentIdMetadata=$documentIdMetadata, errorDetails=$errorDetails, font=$font, fontColor=$fontColor, fontColorMetadata=$fontColorMetadata, fontMetadata=$fontMetadata, fontSize=$fontSize, fontSizeMetadata=$fontSizeMetadata, formOrder=$formOrder, formOrderMetadata=$formOrderMetadata, formPageLabel=$formPageLabel, formPageLabelMetadata=$formPageLabelMetadata, formPageNumber=$formPageNumber, formPageNumberMetadata=$formPageNumberMetadata, formula=$formula, formulaMetadata=$formulaMetadata, height=$height, heightMetadata=$heightMetadata, hidden=$hidden, hiddenMetadata=$hiddenMetadata, isPaymentAmountMetadata=$isPaymentAmountMetadata, italic=$italic, italicMetadata=$italicMetadata, localePolicy=$localePolicy, locked=$locked, lockedMetadata=$lockedMetadata, maxLength=$maxLength, maxLengthMetadata=$maxLengthMetadata, mergeField=$mergeField, mergeFieldXml=$mergeFieldXml, name=$name, nameMetadata=$nameMetadata, originalValue=$originalValue, originalValueMetadata=$originalValueMetadata, pageNumber=$pageNumber, pageNumberMetadata=$pageNumberMetadata, paymentDetails=$paymentDetails, recipientId=$recipientId, recipientIdGuid=$recipientIdGuid, recipientIdGuidMetadata=$recipientIdGuidMetadata, recipientIdMetadata=$recipientIdMetadata, requireAll=$requireAll, requireAllMetadata=$requireAllMetadata, required_=$required_, requiredMetadata=$requiredMetadata, requireInitialOnSharedChange=$requireInitialOnSharedChange, requireInitialOnSharedChangeMetadata=$requireInitialOnSharedChangeMetadata, roundDecimalPlaces=$roundDecimalPlaces, roundDecimalPlacesMetadata=$roundDecimalPlacesMetadata, senderRequired=$senderRequired, senderRequiredMetadata=$senderRequiredMetadata, shared=$shared, sharedMetadata=$sharedMetadata, shareToRecipients=$shareToRecipients, shareToRecipientsMetadata=$shareToRecipientsMetadata, smartContractInformation=$smartContractInformation, source_=$source_, status=$status, statusMetadata=$statusMetadata, tabGroupLabels=$tabGroupLabels, tabGroupLabelsMetadata=$tabGroupLabelsMetadata, tabId=$tabId, tabIdMetadata=$tabIdMetadata, tabLabel=$tabLabel, tabLabelMetadata=$tabLabelMetadata, tabOrder=$tabOrder, tabOrderMetadata=$tabOrderMetadata, tabType=$tabType, tabTypeMetadata=$tabTypeMetadata, templateLocked=$templateLocked, templateLockedMetadata=$templateLockedMetadata, templateRequired=$templateRequired, templateRequiredMetadata=$templateRequiredMetadata, tooltip=$tooltip, toolTipMetadata=$toolTipMetadata, underline=$underline, underlineMetadata=$underlineMetadata, validationMessage=$validationMessage, validationMessageMetadata=$validationMessageMetadata, validationPattern=$validationPattern, validationPatternMetadata=$validationPatternMetadata, value=$value, valueMetadata=$valueMetadata, width=$width, widthMetadata=$widthMetadata, xPosition=$xPosition, xPositionMetadata=$xPositionMetadata, yPosition=$yPosition, yPositionMetadata=$yPositionMetadata]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (formula != null) {
      _json[r'formula'] = formula;
    }
    if (formulaMetadata != null) {
      _json[r'formulaMetadata'] = formulaMetadata;
    }
    if (height != null) {
    ...
    if (hidden != null) {
      _json[r'hidden'] = hidden;
    }
    if (hiddenMetadata != null) {
      _json[r'hiddenMetadata'] = hiddenMetadata;
    }
    if (isPaymentAmountMetadata != null) {
      _json[r'isPaymentAmountMetadata'] = isPaymentAmountMetadata;
    }
    if (italic != null) {
    ...
    if (paymentDetails != null) {
      _json[r'paymentDetails'] = paymentDetails;
    }
    if (recipientId != null) {
    ...
    if (roundDecimalPlaces != null) {
      _json[r'roundDecimalPlaces'] = roundDecimalPlaces;
    }
    if (roundDecimalPlacesMetadata != null) {
      _json[r'roundDecimalPlacesMetadata'] = roundDecimalPlacesMetadata;
    }
  ...
  /// Returns a new [FormulaTab] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FormulaTab? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FormulaTab[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FormulaTab[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return FormulaTab(
        ...
        formulaMetadata: PropertyMetadata.fromJson(json[r'formulaMetadata']),
        ...
        hiddenMetadata: PropertyMetadata.fromJson(json[r'hiddenMetadata']),
        isPaymentAmountMetadata: PropertyMetadata.fromJson(json[r'isPaymentAmountMetadata']),
        ...
        paymentDetails: PaymentDetails.fromJson(json[r'paymentDetails']),
        ...
        roundDecimalPlaces: mapValueOfType<String>(json, r'roundDecimalPlaces'),
        roundDecimalPlacesMetadata: PropertyMetadata.fromJson(json[r'roundDecimalPlacesMetadata']),
  ...
  static List<FormulaTab>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FormulaTab>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FormulaTab.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FormulaTab> mapFromJson(dynamic json) {
    final map = <String, FormulaTab>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FormulaTab.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FormulaTab-objects as value to a dart map
  static Map<String, List<FormulaTab>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FormulaTab>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FormulaTab.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
