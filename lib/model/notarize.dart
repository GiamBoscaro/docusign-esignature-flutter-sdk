...
class Notarize {
  /// Returns a new [Notarize] instance.
  Notarize({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Notarize &&
  ...
  /// Returns a new [Notarize] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static Notarize? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Notarize[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Notarize[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<Notarize>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Notarize>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Notarize.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, Notarize> mapFromJson(dynamic json) {
    final map = <String, Notarize>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Notarize.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of Notarize-objects as value to a dart map
  static Map<String, List<Notarize>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Notarize>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Notarize.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
