...
class CommissionNumber {
  /// Returns a new [CommissionNumber] instance.
  CommissionNumber({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CommissionNumber &&
  ...
  /// Returns a new [CommissionNumber] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CommissionNumber? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CommissionNumber[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CommissionNumber[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CommissionNumber>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CommissionNumber>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CommissionNumber.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CommissionNumber> mapFromJson(dynamic json) {
    final map = <String, CommissionNumber>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CommissionNumber.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CommissionNumber-objects as value to a dart map
  static Map<String, List<CommissionNumber>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CommissionNumber>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CommissionNumber.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
