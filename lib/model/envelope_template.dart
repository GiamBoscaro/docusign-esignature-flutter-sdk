...
class EnvelopeTemplate {
  /// Returns a new [EnvelopeTemplate] instance.
  EnvelopeTemplate({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EnvelopeTemplate &&
  ...
  /// Returns a new [EnvelopeTemplate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EnvelopeTemplate? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EnvelopeTemplate[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EnvelopeTemplate[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<EnvelopeTemplate>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EnvelopeTemplate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EnvelopeTemplate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EnvelopeTemplate> mapFromJson(dynamic json) {
    final map = <String, EnvelopeTemplate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvelopeTemplate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EnvelopeTemplate-objects as value to a dart map
  static Map<String, List<EnvelopeTemplate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EnvelopeTemplate>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvelopeTemplate.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
