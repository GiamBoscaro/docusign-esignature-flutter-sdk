...
class TemplateUpdateSummary {
  /// Returns a new [TemplateUpdateSummary] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TemplateUpdateSummary &&
  ...
  /// Returns a new [TemplateUpdateSummary] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TemplateUpdateSummary? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TemplateUpdateSummary[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TemplateUpdateSummary[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<TemplateUpdateSummary>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TemplateUpdateSummary>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TemplateUpdateSummary.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TemplateUpdateSummary> mapFromJson(dynamic json) {
    final map = <String, TemplateUpdateSummary>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TemplateUpdateSummary.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TemplateUpdateSummary-objects as value to a dart map
  static Map<String, List<TemplateUpdateSummary>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TemplateUpdateSummary>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TemplateUpdateSummary.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
