...
class CertifiedDelivery {
  /// Returns a new [CertifiedDelivery] instance.
  CertifiedDelivery({
    this.accessCode,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CertifiedDelivery &&
  ...
  /// Returns a new [CertifiedDelivery] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CertifiedDelivery? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CertifiedDelivery[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CertifiedDelivery[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CertifiedDelivery>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CertifiedDelivery>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CertifiedDelivery.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CertifiedDelivery> mapFromJson(dynamic json) {
    final map = <String, CertifiedDelivery>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CertifiedDelivery.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CertifiedDelivery-objects as value to a dart map
  static Map<String, List<CertifiedDelivery>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CertifiedDelivery>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CertifiedDelivery.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
