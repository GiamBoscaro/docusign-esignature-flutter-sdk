...
class UserProfile {
  ...
  @override
  String toString() => 'UserProfile[address=$address, authenticationMethods=$authenticationMethods, companyName=$companyName, displayOrganizationInfo=$displayOrganizationInfo, displayPersonalInfo=$displayPersonalInfo, displayProfile=$displayProfile, displayUsageHistory=$displayUsageHistory, profileImageUri=$profileImageUri, title=$title, usageHistory=$usageHistory, userDetails=$userDetails, userProfileLastModifiedDate=$userProfileLastModifiedDate]';
