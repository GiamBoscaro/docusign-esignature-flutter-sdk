...
class EnvelopeDocumentTabs {
  /// Returns a new [EnvelopeDocumentTabs] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EnvelopeDocumentTabs &&
  ...
  /// Returns a new [EnvelopeDocumentTabs] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EnvelopeDocumentTabs? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EnvelopeDocumentTabs[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EnvelopeDocumentTabs[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<EnvelopeDocumentTabs>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EnvelopeDocumentTabs>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EnvelopeDocumentTabs.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EnvelopeDocumentTabs> mapFromJson(dynamic json) {
    final map = <String, EnvelopeDocumentTabs>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvelopeDocumentTabs.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EnvelopeDocumentTabs-objects as value to a dart map
  static Map<String, List<EnvelopeDocumentTabs>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EnvelopeDocumentTabs>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvelopeDocumentTabs.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
