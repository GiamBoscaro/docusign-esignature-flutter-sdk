...
class BrandsResponse {
  ...
  @override
  String toString() => 'BrandsResponse[brands=$brands, recipientBrandIdDefault=$recipientBrandIdDefault, senderBrandIdDefault=$senderBrandIdDefault]';
  ...
  static Map<String, List<BrandsResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = BrandsResponse.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
