...
class CarbonCopy {
  /// Returns a new [CarbonCopy] instance.
  CarbonCopy({
    this.accessCode,
    ...
    this.linkedAccountConfigurationId,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CarbonCopy &&
     ...
     other.linkedAccountConfigurationId == linkedAccountConfigurationId &&
  ...
  int get hashCode =>
    ...
    (linkedAccountConfigurationId == null ? 0 : linkedAccountConfigurationId!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (linkedAccountConfigurationId != null) {
      _json[r'linkedAccountConfigurationId'] = linkedAccountConfigurationId;
    }
  ...
  /// Returns a new [CarbonCopy] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CarbonCopy? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CarbonCopy[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CarbonCopy[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return CarbonCopy(
        ...
        linkedAccountConfigurationId: mapValueOfType<String>(json, r'linkedAccountConfigurationId'),
  ...
  static List<CarbonCopy>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CarbonCopy>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CarbonCopy.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CarbonCopy> mapFromJson(dynamic json) {
    final map = <String, CarbonCopy>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CarbonCopy.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CarbonCopy-objects as value to a dart map
  static Map<String, List<CarbonCopy>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CarbonCopy>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CarbonCopy.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
