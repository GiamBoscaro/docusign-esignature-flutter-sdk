...
class Witness {
  /// Returns a new [Witness] instance.
  Witness({
    this.accessCode,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Witness &&
     ...
     other.userId == userId &&
     other.witnessFor == witnessFor &&
     other.witnessForGuid == witnessForGuid;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (witnessFor != null) {
      _json[r'witnessFor'] = witnessFor;
    }
    if (witnessForGuid != null) {
      _json[r'witnessForGuid'] = witnessForGuid;
    }
    return _json;
  }

  /// Returns a new [Witness] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static Witness? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Witness[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Witness[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return Witness(
        ...
        witnessFor: mapValueOfType<String>(json, r'witnessFor'),
        witnessForGuid: mapValueOfType<String>(json, r'witnessForGuid'),
      );
    }
    return null;
  }

  static List<Witness>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Witness>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Witness.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, Witness> mapFromJson(dynamic json) {
    final map = <String, Witness>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Witness.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of Witness-objects as value to a dart map
  static Map<String, List<Witness>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Witness>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Witness.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
